...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/Zireael26/scavenge/scavenge/commit
   */
  queryCommitAll = (
    query?: {
    ...
    this.request<ScavengeQueryAllCommitResponse, RpcStatus>({
      path: `/Zireael26/scavenge/scavenge/commit`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/Zireael26/scavenge/scavenge/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<ScavengeQueryParamsResponse, RpcStatus>({
      path: `/Zireael26/scavenge/scavenge/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/Zireael26/scavenge/scavenge/scavenge
   */
  queryScavengeAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<ScavengeQueryAllScavengeResponse, RpcStatus>({
      path: `/Zireael26/scavenge/scavenge/scavenge`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
