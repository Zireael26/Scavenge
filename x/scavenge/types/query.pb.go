...
func init() {
	...
	proto.RegisterType((*QueryGetScavengeRequest)(nil), "zireael26.scavenge.scavenge.QueryGetScavengeRequest")
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/zireael26.scavenge.scavenge.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Scavenge(ctx context.Context, in *QueryGetScavengeRequest, opts ...grpc.CallOption) (*QueryGetScavengeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/zireael26.scavenge.scavenge.Query/Scavenge", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ScavengeAll(ctx context.Context, in *QueryAllScavengeRequest, opts ...grpc.CallOption) (*QueryAllScavengeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/zireael26.scavenge.scavenge.Query/ScavengeAll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/zireael26.scavenge.scavenge.Query/Params",
	}
...
func _Query_Scavenge_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/zireael26.scavenge.scavenge.Query/Scavenge",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_ScavengeAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/zireael26.scavenge.scavenge.Query/ScavengeAll",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
